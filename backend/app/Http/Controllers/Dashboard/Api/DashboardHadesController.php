...
final class DashboardHadesController extends Controller
{
    ...
    public function createBootstrapToken(Request $request, HadesTokenService $tokens): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'allowed_capabilities.*' => ['string', 'in:read_files,sync_git_tree,populate_backend_ast'],
    ...
    public function createJob(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'capability' => ['required', 'string', 'in:read_files,sync_git_tree,populate_backend_ast'],
