...
use App\Http\Controllers\Dashboard\Api\DashboardAgentChatController;
...
use App\Http\Controllers\Dashboard\Api\DashboardProjectLogbookController;
...
Route::middleware(['auth', 'active'])->group(function () {
    Route::prefix('/api/dashboard')->group(function () {
        ...
        Route::get('/projects/{project}/logbook', [DashboardProjectLogbookController::class, 'index']);
        Route::get('/projects/{project}/logbook/{entry}', [DashboardProjectLogbookController::class, 'show']);
        Route::post('/projects/{project}/logbook/notes', [DashboardProjectLogbookController::class, 'storeNote']);
        ...
        Route::patch('/wiki/pages/{page}', [DashboardWikiPageController::class, 'update']);
